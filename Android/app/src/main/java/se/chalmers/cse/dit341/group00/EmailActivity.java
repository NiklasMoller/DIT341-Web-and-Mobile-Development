...
public class EmailActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Initialize spinner for Staffmembers and Projects
        initStaffSpinner();
        initProjectSpinner();
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                ...
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        staffMemberList = Arrays.asList(gson.fromJson(dataArray, StaffMember[].class));
                        ArrayAdapter<StaffMember> staffMemberAdapter = new ArrayAdapter<StaffMember>(getApplicationContext(),
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast toast = Toast.makeText(getApplicationContext(),
                                "Could not reach the server. Please try again later.",  Toast.LENGTH_SHORT);
                        toast.show();
