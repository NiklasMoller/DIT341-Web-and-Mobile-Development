...
router.put('/:id', function(req, res) {
   ...
   // projects[id] = updated_project;
    updated_staffMember.save();
    res.json(updated_staffMember);*/
    StaffMember.findById(id, function (err, UpdatedstaffMember) {
        if (err) {
            return next(err);
        }
        ...
        UpdatedstaffMember.name = (req.body.name);
        UpdatedstaffMember.salaryPerHour = (req.body.salaryPerHour);
        UpdatedstaffMember.email = (req.body.email);
        UpdatedstaffMember.save();
